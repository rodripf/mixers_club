...
export function renderReviewCard(review: Review, currentUserId?: string): HTMLElement {
  ...
  if (review.body.length > 150) {
    ...
    viewMoreBtn.style.cssText = 'background:none;border:none;padding:0;color:#2563eb;font-size:0.8rem;cursor:pointer;text-decoration:underline;font-weight:normal;align-self:flex-end'
...
export function buildReviewsSection(
  ...
  if (authenticated && username) {
    ...
    signOutBtn.style.cssText = 'background:none;border:none;padding:0;color:#6b7280;font-size:0.8rem;cursor:pointer;text-decoration:underline'
